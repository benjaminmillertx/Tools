 Here's an updated version of the website cloner specifically for macOS:
...
The changes made in this version are related to the save directory path. The os.path.expanduser() function is used to get the home directory of the current user on macOS, and the desktop path is constructed accordingly.
